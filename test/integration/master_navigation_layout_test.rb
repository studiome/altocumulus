...
class MasterNavigationLayoutTest < ActionDispatch::IntegrationTest
  test "master navigation uses an unclipped daisyUI dropdown with aligned trigger and working links" do
    ...
    assert_select "li.dropdown.dropdown-end > button[type='button'][tabindex='0']", text: "Masters"
    assert_select "li.dropdown.dropdown-end > button.btn", 0
    assert_select "li.dropdown.dropdown-end > button.btn-ghost", 0
